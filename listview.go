...
func VListView(a *Activity, getView func(lv *FListView) IBaseView, bindData func(vh *ViewHolder, pos int), getCount func() int) *FListView {
	v := &FListView{}
	v.VID = NewToken()
...
func HListView(a *Activity, getView func(lv *FListView) IBaseView, bindData func(vh *ViewHolder, pos int), getCount func() int) *FListView {
	v := &FListView{}
	v.VID = NewToken()
